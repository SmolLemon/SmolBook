...
- **Xóa**: xóa một kí tự trong xâu S (`AB` \\(\rightarrow\\) `A`).
...
Bài toán tìm xâu con chung dài nhất cũng là một biến thể của bài toán biến đổi xâu, với chỉ hai thao tác là *xóa* và *thêm* kí tự mà không có chỉnh sửa kí tự.
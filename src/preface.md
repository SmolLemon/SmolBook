...
Tạm dịch tiếng Việt: [Cẩm nang Lập Trình Thi đấu](https://smollemon.github.io/SmolBook/), được viết bởi [Smol Lemon](https://github.com/SmolLemon) được phát hành theo những điều kiện và điều khoản của [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

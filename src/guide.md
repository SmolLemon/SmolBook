...
**Thanh mục lục** ở bên trái chứa mục lục của cuốn cẩm nang. Để có thể xem nội dung của các chương, nhấn vào tên chương tương ứng. Ở các chương có phím mũi tên giúp mở/đóng các phần trong chương.

Thanh mục lục có thể không xuất hiện nếu được xem trên điện thoại hoặc trên trình duyệt với khung cửa sổ nhỏ. Có thể ấn biểu tượng menu (<i class="fas fa-bars"></i>) ở góc trên bên trái của thanh menu để mở thanh bên hoặc đóng nó lại nếu nó xuất hiện.
...
|------|-------------|
| <i class="fas fa-bars"></i> | Đóng hoặc mở thanh mục lục chứa danh sách các chương. |
...
Để thực hiện việc tìm kiếm, ấn vào biểu tượng tìm kiếm (<i class="fas fa-magnifying-glass"></i>) trên thanh menu hoặc nhấn các phím `/`, `s` trên bàn phím để tìm kiếm. Sử dụng phím mũi tên lên xuống để di chuyển giữa các kết quả tìm kiếm. Chọn vào kết quả mong muốn sẽ dẫn bạn đến trang đó và kết quả tìm kiếm sẽ được in đậm. Nhấn phím `esc` để kết thúc tìm kiếm.

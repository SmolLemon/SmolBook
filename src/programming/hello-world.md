...
> [!TIP]
> Để thuận tiện hơn khi lập trình, ta thêm header đặc biệt ở đầu chương trình C++
> 
> ```C++
> #include <bits/stdc++.h>
> ```
...
Dòng thứ năm định nghĩa hàm **main**. Hàm main là hàm bắt đầu chương trình, là hàm được gọi khi chương trình được thực thi. Tất cả các chương trinh C++ đều phải có hàm main. 
...
kết thúc hàm bằng cách trả về giá trị \\(0\\). Đối với hàm main, việc trả về \\(0\\) giúp nói với trình biên dịch rằng: Chương trình của ta chạy trơn tru. Ở các phiên bản mới hơn của C++ (bao gồm cả phiên bản C++14), ta có thể bỏ qua câu lệnh này.

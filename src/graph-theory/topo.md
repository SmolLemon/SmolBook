...
- Chọn một đỉnh \\(u\\) bất kì trong đồ thị có bán bậc vào bằng \\(0\\). Sau khi thêm đỉnh \\(u\\) vào danh sách thứ tự tô-pô, xoá đỉnh \\(u\\) khỏi đồ thị và các cạnh có một trong hai đầu mút là \\(u\\).
